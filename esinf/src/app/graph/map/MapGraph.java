...
public class MapGraph<V, E> extends CommonGraph<V, E> {
    ...
    final private Map<V, MapVertex<V, E>> mapVertices;  // all the Vertices of the app.graph

    // Constructs an empty app.graph (either undirected or directed)
    ...
    public boolean addEdge(V vOrig, V vDest, E weight) {
        ...
        //if app.graph is not direct insert other edge in the opposite direction
        if (!isDirected)
    ...
    //Returns a clone of the app.graph
    @Override
