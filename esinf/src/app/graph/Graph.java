...
public interface Graph<V, E> extends Cloneable {
    ...
    /** Check if app.graph is directed
     * 
     * @return true if app.graph is directed, false otherwise
     */
    boolean isDirected();
    
    /** The total number of vertices in the app.graph
     * 
     * @return the number of vertices of the app.graph
     */
    int numVertices();

    /** All the vertices in the app.graph
     * 
     * @return all the vertices of the app.graph as an ArrayList. Each vertex is in its key position in the ArrayList.
     */
    ArrayList<V> vertices();
    
    /** Check is vertex is in app.graph
     * 
     * @param vert the vertex to check
     * @return true is vert exists in the app.graph, false otherwise
     */
    boolean validVertex(V vert);

    /** Check the numeric key for vert in the app.graph
     * 
     * @param vert the vertex to check
     * @return the numeric key associated with vert, -1 if vert is not in the app.graph
     */
    int key(V vert);

    /** Check the vertex associated with a numeric key in the app.graph
     * 
     * @param key the key to check
     * @return the vertex associated with key, null if key is not in the app.graph
     */
    V vertex(int key);
    ...
    /** The total number of edges of the app.graph
     *
     * @return the number of edges of the app.graph
     */
    int numEdges();

    /** All the edges of the app.graph
     *
     * @return a collection with all the edges of the app.graph.
     */
    Collection<Edge<V, E>> edges();

    /** Finds an edge in the app.graph given its end vertices
     *
    ...
    /** Finds an edge in the app.graph given its end vertex keys
     *
    ...
    /** Adds a new vertex into the app.graph
     * 
     * @param vert the vertex to add
     * @return true if vert is not already in the app.graph, false otherwise
     */
    boolean addVertex(V vert);

    /** Adds a new edge between two vertices. If the vertices are not already in the app.graph, they are added.
     * 
     * @param vOrig origin vertex
     * @param vDest destination vertex
    ...
    /** Removes a vertex and all its incident edges from the app.graph
     *
     * @param vert the vertex to remove
     * @return true if vert was present in the app.graph, false otherwise
     */
     ...
     * @return  true if an edge between vOrig and vDest was present in the app.graph, false otherwise
     */
    boolean removeEdge(V vOrig, V vDest);

    /** Creates a deep copy clone of the app.graph
     *
     * @return a deep copy of app.graph
     */
    Graph<V, E> clone();
}