...
public abstract class CommonGraph <V,E> implements Graph<V,E> {
    ...
    /** Copy app.graph from to app.graph to
     *
     * @param from app.graph from which to copy
     * @param to app.graph for which to copy
     */
     ...
     * @param the other app.graph to test for equality
     * @return true if both objects represent the same app.graph
     */
    @Override
